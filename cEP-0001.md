...
Every community member that started the [newcomer guide](coala.io/newcomer) is
declared a newcomer by invitation into the GitHub organisation. Newcomers can
...
promoted developer. A developer has all the rights of a newcomer but can be an
...
the project and are granted full voting rights due to their achivements.

A developer can be promoted maintainer with a B level decision. This decision
...
convenience feature that is granted to long time contributers as a quality of
life improvement and sign of trust, the voting rights also show the valuation
of ones knowledge and optinions.
It is due to these considerations, that it is valid to promote contributers to
